...
const teamMembers = {
  ...
  members: ["Alice Boizet", "Rayane Elmedjadji", "Mathieu Rouard", "Pierre Larmande", "Valentin Guignon", "Catherine Breton"],
};
                  ...
                  {[
                    {
                      ...
                      url: "https://github.com/SouthGreenPlatform/Gigwa2/releases/download/2.12-RELEASE/Gigwa_V2.12-RELEASE_bundle_creation_windows.ps1",
                      isScript: true,
                    },
                    {
                      version: "v2.11-RELEASE",
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {[
                    {
                      version: "v2.12-RELEASE",
                      url: "https://github.com/SouthGreenPlatform/Gigwa2/releases/download/2.12-RELEASE/Gigwa_V2.12-RELEASE_bundle_creation_ubuntu.sh",
                      isScript: true,
                    },
                    {
                      version: "v2.11-RELEASE",
