  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 rounded-full bg-accent/10 blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }} />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground/80 mb-8 max-w-3xl mx-auto">
              A web-based tool providing an intuitive way to explore large amounts of genotyping data 
              by filtering based on variant features, functional annotations, and genotype patterns.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <Card key={index} className="bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/30 transition-all hover:shadow-lg group">
                <CardHeader>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {liveInstances.map((instance, index) => (
              <Card key={index} className="bg-card border-border/50 hover:border-primary/50 transition-all hover:shadow-lg group">
            ...
            <div>
              ...
              <Card className="bg-card border-border/50">
                <CardContent className="pt-6 space-y-6">
                  <div>
                    <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Referents</h3>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Members</h3>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div className="pt-4 border-t border-border/50">
                    <p className="text-sm text-muted-foreground">
                      <strong>Funding:</strong> This project was funded by Agropolis Fondation under the reference ID ARCAD 0900-001.
                    </p>
                  </div>
                </CardContent>
              </Card>
