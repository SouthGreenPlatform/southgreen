...
export function DatabaseHero({ searchQuery, setSearchQuery, onSearch }: DatabaseHeroProps) {
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
            Genome Hubs and <span className="text-primary">Analytical Tools</span>
          </h1>
          ...
          <div className="flex gap-3 max-w-lg mx-auto mb-8">
            ...
            <Button className="gradient-hero border-0 px-6" onClick={onSearch}>
              Search
            </Button>
          </div>
        </div>
