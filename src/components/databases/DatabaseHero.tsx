...
export function DatabaseHero() {
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-48 h-48 rounded-full bg-accent/10 blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }} />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
            ...
            <span className="text-sm font-medium text-primary">IFB-ELIXIR Member Platform</span>
          </div>
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Explore our integrated information systems for tropical and Mediterranean plants, 
            featuring genome browsers, pangenomic visualization, and high-performance analysis workflows.
          </p>
          ...
          <div className="flex gap-3 max-w-lg mx-auto mb-8">
            ...
            <Button className="gradient-hero border-0 px-6">
              Search
            </Button>
          </div>
          ...
          <div className="flex justify-center gap-8 text-center">
            ...
            <div className="w-px bg-border" />
            <div>
              <p className="text-3xl font-semibold text-foreground">ISO 9001</p>
